...
create table track(track_id int primary key,name text,
album_id int,
media_type_id int,
genre_id int,
composer text,
...
SELECT COUNT(*) AS country, billing_country FROM invoice GROUP BY billing_country ORDER BY country DESC;
